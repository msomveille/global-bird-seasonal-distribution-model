...
run1 = @spawn migraModel(10, 0, 5/3, 1+(5*(76.5/9)), 0.01+(1/3*(0.24/9)))
run2 = @spawn migraModel(10, 0, 6/3, 1+(5*(76.5/9)), 0.01+(1/3*(0.24/9)))
run3 = @spawn migraModel(10, 0, 7/3, 1+(5*(76.5/9)), 0.01+(1/3*(0.24/9)))
run4 = @spawn migraModel(10, 0, 8/3, 1+(5*(76.5/9)), 0.01+(1/3*(0.24/9)))
run5 = @spawn migraModel(10, 0, 9/3, 1+(5*(76.5/9)), 0.01+(1/3*(0.24/9)))
...
save("resmec12.jld", "data", resmechh)
