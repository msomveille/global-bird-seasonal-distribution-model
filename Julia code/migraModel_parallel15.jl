...
run1 = @spawn migraModel(10, 0, 0/3, 1+(7*(76.5/9)), 0.01+(1/3*(0.24/9)))
run2 = @spawn migraModel(10, 0, 1/3, 1+(7*(76.5/9)), 0.01+(1/3*(0.24/9)))
run3 = @spawn migraModel(10, 0, 2/3, 1+(7*(76.5/9)), 0.01+(1/3*(0.24/9)))
run4 = @spawn migraModel(10, 0, 3/3, 1+(7*(76.5/9)), 0.01+(1/3*(0.24/9)))
run5 = @spawn migraModel(10, 0, 4/3, 1+(7*(76.5/9)), 0.01+(1/3*(0.24/9)))
...
save("resmec15.jld", "data", resmechh)
